...
public abstract class AbstractEventService<S, E> {
    ...
    public boolean processUserInput(Update update) throws Exception {
        ...
        return stateMachineService.handleEvent(telegramUserId.toString(), MessageBuilder.withPayload(event)
                .setHeader("text", text)
